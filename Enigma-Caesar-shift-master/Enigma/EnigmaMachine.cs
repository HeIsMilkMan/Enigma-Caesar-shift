...
namespace Enigma
{
    ...
    public static class EnigmaMachine
    {
        ...
        public static string FormatOutputMessage(string message)
        {
            ...
            for(int i =0; i < message.ToLower().Length; i ++)
            {
               
                if (i == 0)
                {
                    FortmatedOutPut.Append(message[i].ToString().ToUpper());
                }
                if (message[i] == '?' || message[i] == '€')
                {
                    ...
                    if(message[i] == '?')
                    {
                        FortmatedOutPut.Append(message[i]);
                    }
                    else
                    {
                        FortmatedOutPut.Append(message[i]);
            ...
            return FortmatedOutPut.ToString();
        }
